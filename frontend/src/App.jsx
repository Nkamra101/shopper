      ...
      <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
        <div className="brand-block">
          ...
          <div>
            ...
            <p className="brand-tagline">Smart scheduling</p>
          </div>
        </div>
...
export default function App() {
  ...
  return (
    <Routes>
      {/* Landing / home — shows landing for guests, dashboard for logged-in */}
      ...
      <Route path="/bookings" element={<ProtectedRoute><AdminLayout title="Bookings" subtitle="Upcoming and past meetings"><BookingsPage /></AdminLayout></ProtectedRoute>} />
      ...
      <Route path="/integrations" element={<ProtectedRoute><AdminLayout title="Integrations" subtitle="Connect your tools"><IntegrationsPage /></AdminLayout></ProtectedRoute>} />
      ...
      <Route path="/workflows" element={<ProtectedRoute><AdminLayout title="Workflows" subtitle="Automated email reminders & notifications"><WorkflowsPage /></AdminLayout></ProtectedRoute>} />
